...
p_rain = F(1, 3)           # probability of day is rainy
p_rain_traffic = F(1, 2)       # probability of heavy traffic after rain
p_noRain_traffic = F(1, 4)     # probability of heavy traffic after no rain
# probability of getting late after rain followed by heavy traffic
p_rain_traffic_late = F(1, 2)
# if no rain followed by no heavy traffic
p_noRain_noTraffic_late = F(1, 8)
# other remaining conditions not rainy followed by heavy traffic and rain followed by no heavy traffic
p_rain_noTraffic_late = p_noRain_traffic_late = F(1, 4)
