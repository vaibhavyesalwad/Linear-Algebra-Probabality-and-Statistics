...
from fractions import Fraction as F           # using fractions module
cards = 52        # total cards in total pack
aces = 4           # total ace cards
print(f'Probability of an ace from pack of cards: {F(aces, cards)}')       # representing probability in fraction
